...
The core C system is implemented in \texttt{src/} with interfaces in \texttt{include/}:
\begin{itemize}
...
The keyboard driver configures the terminal using POSIX \texttt{termios}:
\begin{itemize}
...
\bibitem{b3} The Open Group, \textit{The termios Interface (POSIX)}, 2017.
